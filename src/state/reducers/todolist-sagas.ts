...
export const removeTodolist = (todoListId: string) => ({type: 'TODOLIST/REMOVE-TODOLIST', todoListId});
...
export const addTodolist = (title: string) => ({type: 'TODOLIST/REMOVE-TODOLIST', title});
...
export function* todolistWatcherSaga() {
    ...
    yield takeEvery('TODOLIST/REMOVE-TODOLIST', addTodolistWorkerSaga)
    yield takeEvery('TODOLIST/CHANGE-TODOLIST-TITLE', changeTodolistTitleWorkerSaga)
